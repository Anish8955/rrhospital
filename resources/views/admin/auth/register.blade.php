...
<head>
  ...
  <link rel="stylesheet" href="{{asset('front/assets/vendor/css/theme-default.css')}}"
          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-body fw-bold">R&R Hospital</span>
              </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-2">Happy life starts here 🚀</h4>
            <p class="mb-4">Make your life better!</p>

            <form id="formAuthentication" method="post" class="mb-3" action="{{ route('register.post')}}">
              @csrf
              <div class="mb-3">
              ...
              <div class="mb-3 form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                  <input type="password" id="password" class="form-control" name="password_confirmation"
                    placeholder="Re-Enter your password" aria-describedby="password" />
                  <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                </div>
              </div>
